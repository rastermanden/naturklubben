...
| `game_scores`                              | Resultater fra spil-sektionen (#202), ét spil pr. række. `game` afgrænser listen, og et check-constraint holder point op mod antallet af ryddede rækker, så et umuligt tal ikke kan lande på listen.                                   | Alle medlemmer kan læse -- resultatlisten er hele pointen. Man kan kun indsætte sit eget resultat, UPDATE er revoked (et resultat rettes ikke bagefter), og både spilleren selv og admins kan slette.               |
